...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            <h1>Pendaftaran Perusahaan</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item">Perusahaan</div>
                <div class="breadcrumb-item active">Pendaftaran Perusahaan</div>
            </div>
        </div>
                                    ...
                                    <tbody>                                        
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-icon icon-left btn-success m-1" data-toggle="modal" data-target="#modal-accept" data-backdrop="static" data-keyboard="false"><i class="fas fa-check"></i> Terima</button>
                                                <button class="btn btn-icon icon-left btn-danger m-1" data-toggle="modal" data-target="#modal-decline" data-backdrop="static" data-keyboard="false"><i class="fas fa-times"></i> Tolak</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
    ...
    <?php /*MODAL TERIMA*/?>
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-accept">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="delete-form" action="<?= base_url()?>/Live/delete" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">                            
                                <p style="text-align:center;">Apakah anda yakin untuk menerima data ini?</p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batalkan</button>
                        <button id="send-button" type="submit" class="btn btn-success submit-button">Terima</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <?php /*END MODAL TERIMA*/?>

    <?php /*MODAL DECLINE*/?>
    <div class="modal fade" tabindex="-1" role="dialog" id="modal-decline">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Tolak Data</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="delete-form" action="<?= base_url()?>/Live/delete" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-md-12 col-lg-12">                            
                                <p style="text-align:center;">Apakah anda yakin untuk menolak data ini?</p>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer bg-whitesmoke br">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Batalkan</button>
                        <button id="delete-button" type="submit" class="btn btn-danger submit-button">Tolak</button>
                    </div>
                </form>
            </div>
        </div>
    </div>
    <?php /*END MODAL DECLINE*/?>
